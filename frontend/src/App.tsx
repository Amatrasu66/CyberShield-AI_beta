...
function ConsoleRoutes() {
  return <RequireAuth><AppShell><Routes><Route path="/dashboard" element={<DashboardPage />} /><Route path="/website-scanner" element={<WebsiteScannerPage />} /><Route path="/phishing-detector" element={<EmailDetectorPage />} /><Route path="/password-analyzer" element={<ToolPage path="/password-analyzer" />} /><Route path="/log-analyzer" element={<ToolPage path="/log-analyzer" />} /><Route path="/sql-playground" element={<ToolPage path="/sql-playground" />} /><Route path="/cryptography-lab" element={<ToolPage path="/cryptography-lab" />} /><Route path="/reports" element={<ReportsPage />} /><Route path="/profile" element={<ProfilePage />} /><Route path="/settings" element={<SettingsPage />} /><Route path="*" element={<NotFoundPage />} /></Routes></AppShell></RequireAuth>;
}
