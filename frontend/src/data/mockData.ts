...
export const tools: Record<string, ToolSpec> = {
  ...
  '/log-analyzer': { eyebrow: 'Security telemetry', title: 'Log Analyzer', description: 'Upload or paste server events to identify anomalous activity and priority incidents.', inputLabel: 'Log content', inputPlaceholder: 'Paste access or application logs…', action: 'Analyze logs', resultTitle: 'Anomalies detected', resultValue: '7 events', resultDetail: 'Demo result: repeated authentication failures from a single source.', tableHeaders: ['Timestamp', 'Event', 'Severity'], rows: [['10:42:19', 'Repeated failed login', 'High'], ['10:41:51', 'Unknown user agent', 'Medium'], ['10:39:12', 'Successful login', 'Low']], status: 'danger' },
  '/sql-playground': { eyebrow: 'Secure coding lab', title: 'SQL Injection Playground', description: 'Explore how parameterized queries protect an intentionally isolated learning example.', inputLabel: 'Demo query input', inputPlaceholder: "' OR '1'='1", action: 'Run safe demo', resultTitle: 'Defense status', resultValue: 'Parameterized', resultDetail: 'The simulated query treats input as data, not executable SQL.', tableHeaders: ['Technique', 'Result', 'Explanation'], rows: [['String concatenation', 'Blocked', 'Unsafe approach shown only for education'], ['Parameterized query', 'Safe', 'Input is bound as a parameter'], ['Input validation', 'Enabled', 'Demo policy applied']], status: 'success' },
  '/cryptography-lab': { eyebrow: 'Applied cryptography', title: 'Cryptography Lab', description: 'Experiment with high-level encryption, hashing, and encoding concepts using static examples.', inputLabel: 'Sample text', inputPlaceholder: 'Enter text to illustrate the operation', action: 'Run demonstration', resultTitle: 'Selected operation', resultValue: 'SHA-256', resultDetail: 'Static learning output; no sensitive data is processed or stored.', tableHeaders: ['Property', 'Value', 'Notes'], rows: [['Algorithm', 'SHA-256', 'One-way hash'], ['Digest length', '256 bits', 'Fixed output size'], ['Use case', 'Integrity', 'Not encryption']], status: 'primary' },
};
